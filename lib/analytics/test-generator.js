...
class TestGeneratorAgent extends BaseAgent {
   ...
   * @returns {Array}
   */
  _generateUnitTests(model, _options) {
    const tests = [];
  ...
  _generateMochaTests(model) {
    const name = model.name || 'Model';
    const _fields = model.fields || model.columns || [];
   ...
   * @returns {Array}
   */
  _generateIntegrationTests(model, _options) {
    const tests = [];
    const modelName = model.name || 'Model';
   ...
   * @returns {Array}
   */
  _generateSchemaTests(model, _options) {
    const tests = [];
    const modelName = model.name || 'Model';
    const fields = model.fields || model.columns || [];
   ...
   * @returns {Array}
   */
  _generateDataQualityTests(model, _options) {
    const tests = [];
    const modelName = model.name || 'Model';
