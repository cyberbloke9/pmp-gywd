...
@~/.claude/get-your-work-done/references/principles.md
@~/.claude/get-your-work-done/references/questioning.md
@~/.claude/get-your-work-done/templates/project.md
@~/.claude/get-your-work-done/templates/config.json
...
1. **Abort if project exists:**
   ```bash
   [ -f .planning/PROJECT.md ] && echo "ERROR: Project already initialized. Use /gywd:progress" && exit 1
   ```
...
- options:
  - "Map codebase first" — Run /gywd:map-codebase to understand existing architecture (Recommended)
  - "Skip mapping" — Proceed with project initialization

**If "Map codebase first":**
```
Run `/gywd:map-codebase` first, then return to `/gywd:new-project`
```
Exit command.
...
Present completion with next steps (see ~/.claude/get-your-work-done/references/continuation-format.md):
