...
- Example: `/gywd:remove-phase 17` → phase = 17
- Example: `/gywd:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /gywd:remove-phase <phase-number>
Example: /gywd:remove-phase 17
```
...
To abandon current work, use /gywd:pause-work instead.
```
...
Would you like to:
- `/gywd:progress` — see updated roadmap status
