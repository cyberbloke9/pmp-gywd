...
**Purpose:** Capture issues found during /gywd:verify-work. Unlike global ISSUES.md (for deferred enhancements), this file tracks bugs and problems in specific delivered work.
...
**Tester:** User via /gywd:verify-work
...
[Moved here after /gywd:plan-fix executes and fixes are verified]
...
<guidelines>
**When to create:**
- First time /gywd:verify-work finds an issue for a plan
...
**Workflow:**
1. /gywd:verify-work creates this file with issues
2. /gywd:plan-fix reads this file and creates FIX.md plan
