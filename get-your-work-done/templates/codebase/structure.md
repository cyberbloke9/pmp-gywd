...
│   └── GYWD/           # GYWD-specific commands
├── get-your-work-done/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/GYWD/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `get-your-work-done/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `get-your-work-done/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/get-your-work-done/workflows/{name}.md`

**New Reference Document:**
- Implementation: `get-your-work-done/references/{name}.md`
