...
**Purpose:** Persist milestone discussion context so `/clear` can be used between commands. This file is consumed by `/gywd:new-milestone` and deleted after the milestone is created.
...
**Generated:** [date]
**Status:** Ready for /gywd:new-milestone
...
*This file is temporary. It will be deleted after /gywd:new-milestone creates the milestone.*
```
...
**Lifecycle:**
1. `/gywd:discuss-milestone` creates this file at end of discussion
2. User runs `/clear` (safe now - context is persisted)
3. `/gywd:new-milestone` reads this file
4. `/gywd:new-milestone` uses context to populate milestone
5. `/gywd:new-milestone` deletes this file after successful creation
