...
Exit skill and invoke SlashCommand("/gywd:plan-phase [X+1]")
...
**Also available:**
- `/gywd:discuss-phase [X+1]` — gather context first
- `/gywd:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/gywd:complete-milestone {version}")
