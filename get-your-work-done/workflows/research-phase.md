...
Triggered by /gywd:research-phase command when the domain is niche, complex, or Claude's training is likely stale.
...
Use /gywd:progress to see available phases.
```
Exit workflow.
...
**2. Phase context (if exists from /gywd:discuss-phase):**
```bash
...
**From ~/.claude/get-your-work-done/references/research-pitfalls.md:**
...
Use template from ~/.claude/get-your-work-done/templates/research.md
...
What's next?
1. Plan this phase (/gywd:plan-phase ${PHASE}) - RESEARCH.md will be loaded automatically
...
When /gywd:plan-phase runs after research:
