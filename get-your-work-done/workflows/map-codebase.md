...
1. **Read template file** from `~/.claude/get-your-work-done/templates/codebase/{name}.md`
...
**Also available:**
- Re-run mapping: `/gywd:map-codebase`
...
- User offered clear next steps in GYWD style
</success_criteria>
