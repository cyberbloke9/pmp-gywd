...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /gywd:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/get-your-work-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Quality check:** Before finalizing findings, consult ~/.claude/get-your-work-done/references/research-pitfalls.md to avoid common research gaps.

7. **Create DISCOVERY.md** using ~/.claude/get-your-work-done/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/get-your-work-done/templates/discovery.md:
...
6. **Quality check:** Before finalizing findings, consult ~/.claude/get-your-work-done/references/research-pitfalls.md to ensure comprehensive coverage and avoid common research gaps.

7. **Create comprehensive DISCOVERY.md:**

   - Full structure from ~/.claude/get-your-work-done/templates/discovery.md
...
Use ~/.claude/get-your-work-done/templates/discovery.md.
...
1. Discuss phase context (/gywd:discuss-phase [current-phase])
2. Create phase plan (/gywd:plan-phase [current-phase])
