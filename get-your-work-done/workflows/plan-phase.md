...
1. ~/.claude/get-your-work-done/templates/phase-prompt.md
2. ~/.claude/get-your-work-done/references/plan-format.md
3. ~/.claude/get-your-work-done/references/scope-estimation.md
4. ~/.claude/get-your-work-done/references/checkpoints.md
5. ~/.claude/get-your-work-done/references/tdd.md
...
For niche domains (3D, games, audio, shaders, ML), suggest `/gywd:research-phase` before plan-phase.
</step>
...
- Any {phase}-RESEARCH.md (from /gywd:research-phase)
- Any DISCOVERY.md (from mandatory discovery)
- Any {phase}-CONTEXT.md (from /gywd:discuss-phase)
...
# Check for ecosystem research (from /gywd:research-phase)
cat .planning/phases/XX-name/${PHASE}-RESEARCH.md 2>/dev/null

# Check for phase context (from /gywd:discuss-phase)
...
**If neither exist:** Suggest /gywd:research-phase for niche domains, /gywd:discuss-phase for simpler domains, or proceed with roadmap only.
</step>
...
See ~/.claude/get-your-work-done/references/checkpoints.md for checkpoint structure.
</step>
...
See ~/.claude/get-your-work-done/references/scope-estimation.md for complete guidance.
</step>
...
Use template from `~/.claude/get-your-work-done/templates/phase-prompt.md`.
...
`/gywd:execute-plan .planning/phases/XX-name/{phase}-01-PLAN.md`
...
**TDD candidates get dedicated plans.** If "Create price calculator with discount rules" warrants TDD, create a TDD plan for it. See `~/.claude/get-your-work-done/references/tdd.md` for TDD plan structure.
</task_quality>
