...
1. ~/.claude/get-your-work-done/templates/roadmap.md
2. ~/.claude/get-your-work-done/templates/state.md
...
Use template from `~/.claude/get-your-work-done/templates/roadmap.md`.

Initial roadmaps use integer phases (1, 2, 3...).
Decimal phases added later via /gywd:insert-phase command (if it exists).
...
Use template from `~/.claude/get-your-work-done/templates/state.md`.
