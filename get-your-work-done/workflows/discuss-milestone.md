...
Did you want to:
1. Complete current milestone first (/gywd:complete-milestone)
2. Add phases to current milestone (/gywd:add-phase)
...
- options (ALL THREE REQUIRED):
  - "Create milestone" - Proceed to /gywd:new-milestone
...
Use template from ~/.claude/get-your-work-done/templates/milestone-context.md
