...
**If .planning/ doesn't exist:** This is a new project - route to /gywd:new-project
</step>
...
1. Resume from checkpoint (/gywd:execute-plan .planning/phases/XX-name/.continue-here-02-01.md)
   OR
1. Execute next plan (/gywd:execute-plan .planning/phases/XX-name/02-02-PLAN.md)
   OR
1. Discuss Phase 3 context (/gywd:discuss-phase 3) [if CONTEXT.md missing]
   OR
1. Plan Phase 3 (/gywd:plan-phase 3) [if CONTEXT.md exists or discuss option declined]
